...
function getDefinitions(category) {
  var namespaceItems = {
    "class":        { inClass: true,        typePropertyName: "inClass",        id: "classes",      isEmbedded: false },
    "struct":       { inStruct: true,       typePropertyName: "inStruct",       id: "structs",      isEmbedded: false },
    "interface":    { inInterface: true,    typePropertyName: "inInterface",    id: "interfaces",   isEmbedded: false },
    "enum":         { inEnum: true,         typePropertyName: "inEnum",         id: "enums",        isEmbedded: false },
    "delegate":     { inDelegate: true,     typePropertyName: "inDelegate",     id: "delegates",    isEmbedded: false },
    "package":      { inPackage: true,      typePropertyName: "inPackage",      id: "packages",     isEmbedded: false },
    "namespace":    { inNamespace: true,    typePropertyName: "inNamespace",    id: "namespaces",   isEmbedded: false },
